...
class _MyHomePageState extends State<MyHomePage> {
  ...
  TouchBarLabel counterLabel = TouchBarLabel(
    'Counter: 0',
  ...
  void loadAssyncData() async {
    ...
    scrubber = TouchBarScrubber(
        ...
        onHighlight: (childId) => setState(() {
              isHighlightingTheColor = true;
              highlightColor = colors[childId % colors.length];
            }));
          ...
          children: <Widget>[
            if (isHighlightingTheColor)
              Row(
                ...
                children: [
                  const Text('You are highlightining the color '),
                  SizedBox(
                    width: 20,
                    height: 20,
                    child: DecoratedBox(
